...
export const AccountApiAxiosParamCreator = function(configuration?: Configuration) {
  return {
     ...
     * @throws {RequiredError}
     */
    apiAccountMfaMfaStringPost: async (
      mfaString: string,
      options: AxiosRequestConfig = {}
    ): Promise<RequestArgs> => {
      ...
      if (mfaString === null || mfaString === undefined) {
        throw new RequiredError(
          'mfaString',
          'Required parameter mfaString was null or undefined when calling apiAccountMfaMfaStringPost.'
        );
      }
      const localVarPath = `/api/Account/mfa/{mfaString}`.replace(
        `{${'mfaString'}}`,
        encodeURIComponent(String(mfaString))
      );
      // use dummy base URL string because the URL constructor only accepts absolute URLs.
      const localVarUrlObj = new URL(localVarPath, 'https://example.com');
      let baseOptions;
...
export const AccountApiFp = function(configuration?: Configuration) {
  return {
    ...
    async apiAccountLoginPost(
      body?: LoginDto,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<TokenDto>>> {
     ...
     * @throws {RequiredError}
     */
    async apiAccountMfaMfaStringPost(
      mfaString: string,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => Promise<AxiosResponse<TokenDto>>> {
      const localVarAxiosArgs = await AccountApiAxiosParamCreator(
        configuration
      ).apiAccountMfaMfaStringPost(mfaString, options);
      return (axios: AxiosInstance = globalAxios, basePath: string = BASE_PATH) => {
        const axiosRequestArgs: AxiosRequestConfig = {
          ...localVarAxiosArgs.options,
          url: basePath + localVarAxiosArgs.url
...
export class AccountApi extends BaseAPI {
   ...
   * @memberof AccountApi
   */
  public async apiAccountLoginPost(
    body?: LoginDto,
    options?: AxiosRequestConfig
  ): Promise<AxiosResponse<TokenDto>> {
   ...
   * @memberof AccountApi
   */
  public async apiAccountMfaMfaStringPost(
    mfaString: string,
    options?: AxiosRequestConfig
  ): Promise<AxiosResponse<TokenDto>> {
    return AccountApiFp(this.configuration)
   ...
   * @memberof AccountApi
   */
  public async apiAccountRegisterPost(
    body?: RegisterDto,
    options?: AxiosRequestConfig
  ): Promise<AxiosResponse<TokenDto>> {
    return AccountApiFp(this.configuration)
